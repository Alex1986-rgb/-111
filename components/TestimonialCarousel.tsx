    ...
    <section className="py-9 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-5">
          <h2 className="text-3xl md:text-4xl font-black mb-4">Голоса наших <span className="text-indigo-600">клиентов</span></h2>
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="relative bg-slate-50 rounded-[3rem] p-6 md:p-16 border border-slate-100 shadow-sm overflow-hidden min-h-[400px] flex items-center">
            ...
            <div className={`relative z-10 w-full transition-all duration-500 ease-out ${isAnimating ? 'opacity-0 scale-95 translate-x-4' : 'opacity-100 scale-100 translate-x-0'}`}>
              <div className="flex flex-col md:flex-row gap-5 items-center">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <blockquote className="text-lg md:text-3xl font-medium text-slate-800 mb-5 leading-tight italic">
