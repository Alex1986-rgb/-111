      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-5">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 tracking-tight leading-[0.95]">
              {title}
            </h2>
            {subtitle && (
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-black text-slate-900 mb-5">Часто задаваемые вопросы</h3>
            <div className="space-y-4">
              {faqs.map((faq, i) => (
                <div 
                  key={i} 
                ...
                >
                  <button 
                    ...
                    className="w-full p-6 md:p-6 flex justify-between items-center text-left"
                  >
                    <span className="text-base md:text-base font-black text-slate-900 leading-tight">{faq.q}</span>
