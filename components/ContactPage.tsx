...
const ContactPage: React.FC = () => {
  ...
  const contactFaqs = [
    { q: 'Как быстро вы отвечаете на заявки?', a: 'В рабочее время (с 10:00 до 19:00 по Москве) мы связываемся с вами в течение 30-60 минут. Заявки, оставленные в нерабочее время, обрабатываются в приоритетном порядке на следующее утро.' },
    { q: 'Можно ли заказать тестовое задание?', a: 'Да, мы выполняем платные тестовые задания объемом до 2000 знаков. Это позволяет вам оценить наш стиль и качество проработки темы перед заключением основного договора.' },
    { q: 'Работаете ли вы с НДС?', a: 'Да, мы работаем как с НДС, так и без НДС. Мы предоставляем полный пакет закрывающих документов через ЭДО или курьерской службой.' },
    { q: 'Где находится ваш офис?', a: 'Наш основной офис расположен в Москве, в башне "Федерация" (Москва-Сити). Мы всегда рады видеть клиентов у себя в гостях по предварительной договоренности.' }
  ];
    ...
    <div className="max-w-7xl mx-auto px-4 py-8 md:py-8">
      <div className="grid lg:grid-cols-2 gap-16 md:gap-24 items-start">
        <div className="animate-in fade-in slide-in-from-left duration-700">
          <h1 className="text-3xl md:text-4xl font-black mb-5 md:mb-4 tracking-tighter leading-none">Давайте <br /><span className="text-indigo-600">обсудим</span> проект</h1>
          <p className="text-slate-500 text-base md:text-lg font-medium mb-4 md:mb-5 leading-relaxed">
            ...
            {socialLinks.map((s) => {
              ...
              return (
                <a 
                  ...
                  className="flex flex-col p-6 bg-white border border-slate-100 rounded-[2.5rem] shadow-sm hover:shadow-2xl hover:scale-[1.02] transition-all group relative overflow-hidden"
                >
                  <div className={`w-14 h-14 ${s.color} text-white rounded-2xl flex items-center justify-center mb-4 shadow-xl ${s.shadow} group-hover:rotate-6 transition-transform`}>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-4 group">
              ...
              <div>
                ...
                <a href="mailto:hello@textflow.ru" className="text-lg md:text-2xl font-black text-slate-900 hover:text-indigo-600 transition-colors">hello@textflow.ru</a>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 group">
              ...
              <div>
                ...
                <a href="tel:+79991234567" className="text-lg md:text-2xl font-black text-slate-900 hover:text-indigo-600 transition-colors">+7 (999) 123-45-67</a>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 group">
              ...
              <div>
                ...
                <p className="text-lg md:text-2xl font-black text-slate-900 leading-tight">Москва, Пресненская наб., 12 <br /><span className="text-slate-300 text-sm">Башня Федерация</span></p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-900 p-6 md:p-16 rounded-[4rem] shadow-2xl relative overflow-hidden animate-in fade-in slide-in-from-right duration-700">
          ...
          {sent ? (
            <div className="text-center py-9 animate-in fade-in zoom-in">
              <div className="w-24 h-24 bg-emerald-500 text-white rounded-[2.5rem] flex items-center justify-center mx-auto mb-5 shadow-2xl shadow-emerald-500/20">
                <Send className="w-10 h-10" />
              </div>
              <h3 className="text-3xl font-black text-white mb-4">Сообщение отправлено!</h3>
              <p className="text-slate-400 font-medium mb-4">Мы получили вашу заявку и свяжемся с вами в течение 30 минут.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
              ...
              <button type="submit" className="w-full bg-indigo-600 text-white py-6 rounded-[1.5rem] font-black text-base flex items-center justify-center gap-4 hover:bg-indigo-700 transition-all shadow-2xl shadow-indigo-600/20 active:scale-[0.98] group">
      ...
      <SEOSection 
        title="Свяжитесь с лучшей редакцией"
        subtitle="Мы всегда на связи, чтобы помочь вашему бизнесу заговорить на языке прибыли."
        seoText={`
          <p>Выбор партнера по контенту — это ответственный шаг. В TextFlow мы стремимся сделать коммуникацию максимально простой и эффективной. Вы можете написать нам в мессенджеры, позвонить или оставить заявку через форму — мы ответим максимально оперативно.</p>
          <p><strong>Почему стоит начать обсуждение прямо сейчас?</strong> Рынок контента меняется быстро, и чем раньше мы начнем разработку вашей стратегии, тем быстрее вы получите преимущество перед конкурентами. Мы готовы обсудить проекты любой сложности: от разовых статей до масштабного наполнения порталов.</p>
